...
# Daten generieren
X = df[["minFrequence","maxFrequence", "avgFrequence", "skewnessFrequence", "varianceFrequence", "energyFrequence", "kurtosisFrequence", "minAmplitude", "maxAmplitude", "avgAmplitude", "skewnessAmplitude", "varianceAmplitude", "energyAmplitude", "kurtosisAmplitude"]]
y = categoryArray
