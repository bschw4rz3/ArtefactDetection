...
std::vector<DataPoint> KMeansService::classify(std::vector<DataPoint>& trainingsData, std::vector<std::vector<double>>& testData)
{
...
std::vector<int> KMeansService::classify(std::vector<std::vector<std::complex<double>>> trainingsFeatures, std::vector<std::vector<std::complex<double>>> testFeatures, std::vector< std::complex<double>> classes)
{
...
std::vector<std::vector<std::complex<double>>> KMeansService::getFeature(std::vector<DataPoint>& trainingData)
{
...
std::vector<std::complex<double>> KMeansService::getLabels(std::vector<DataPoint>& trainingData)
{
    std::vector<std::complex<double>> classes;
    std::vector<std::vector<std::complex<double>>> features;
...
std::vector<std::vector<std::complex<double>>> KMeansService::toComplex(std::vector<std::vector<double>>& testData)
{
...
std::string KMeansService::getScriptName()
{
    return "trainKMeans.py";
}