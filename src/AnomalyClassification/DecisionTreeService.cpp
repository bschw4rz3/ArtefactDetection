...
std::vector<DataPoint> DecisionTreeService::classify(std::vector<DataPoint>& trainingsData, std::vector<std::vector<double>>& testData)
{
...
std::vector<int> DecisionTreeService::classify(std::vector<std::vector<std::complex<double>>> trainingsFeatures, std::vector<std::vector<std::complex<double>>> testFeatures, std::vector< std::complex<double>> classes)
{
...
std::vector<std::vector<std::complex<double>>> DecisionTreeService::getFeature(std::vector<DataPoint>& trainingData)
{
...
std::vector<std::complex<double>> DecisionTreeService::getLabels(std::vector<DataPoint>& trainingData)
{
    std::vector<std::complex<double>> classes;
    std::vector<std::vector<std::complex<double>>> features;
...
std::vector<std::vector<std::complex<double>>> DecisionTreeService::toComplex(std::vector<std::vector<double>>& testData)
{
...
std::string DecisionTreeService::getScriptName()
{
    return "trainDecisionTree.py";
}