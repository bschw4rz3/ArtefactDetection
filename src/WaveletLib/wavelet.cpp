...
double* wavelet::cascade(int n, int t_length, double t[], int c_length, double c[])
...
double* wavelet::daub_coefficients(int n)
...
double* wavelet::daub2_matrix(int n)
...
double wavelet::daub2_scale(int n, double x)
...
double* wavelet::daub2_transform(int n, double x[])
...
double* wavelet::daub2_transform_inverse(int n, double y[])
...
double* wavelet::daub4_matrix(int n)
...
double wavelet::daub4_scale(int n, double x)
...
double* wavelet::daub4_transform(int n, double x[])
...
double* wavelet::daub4_transform_inverse(int n, double y[])
...
double* wavelet::daub6_matrix(int n)
...
double wavelet::daub6_scale(int n, double x)
...
double* wavelet::daub6_transform(int n, double x[])
...
double* wavelet::daub6_transform_inverse(int n, double y[])
...
double* wavelet::daub8_matrix(int n)
...
double wavelet::daub8_scale(int n, double x)
...
double* wavelet::daub8_transform(int n, double x[])
...
double* wavelet::daub8_transform_inverse(int n, double y[])
...
double* wavelet::daub10_matrix(int n)
...
double wavelet::daub10_scale(int n, double x)
...
double* wavelet::daub10_transform(int n, double x[])
...
double* wavelet::daub10_transform_inverse(int n, double y[])
...
double* wavelet::daub12_matrix(int n)
...
double* wavelet::daub12_transform(int n, double x[])
...
double* wavelet::daub12_transform_inverse(int n, double y[])
...
double* wavelet::daub14_transform(int n, double x[])
...
double* wavelet::daub14_transform_inverse(int n, double y[])
...
double* wavelet::daub16_transform(int n, double x[])
...
double* wavelet::daub16_transform_inverse(int n, double y[])
...
double* wavelet::daub18_transform(int n, double x[])
...
double* wavelet::daub18_transform_inverse(int n, double y[])
...
double* wavelet::daub20_transform(int n, double x[])
...
double* wavelet::daub20_transform_inverse(int n, double y[])
...
int wavelet::i4_is_power_of_2(int n)
...
int wavelet::i4_max(int i1, int i2)
...
int wavelet::i4_min(int i1, int i2)
...
int wavelet::i4_modp(int i, int j)
...
int wavelet::i4_wrap(int ival, int ilo, int ihi)
...
double wavelet::r8_uniform_01(int* seed)
...
double wavelet::r8mat_is_identity(int n, double a[])
...
double* wavelet::r8mat_zero_new(int m, int n)
...
double* wavelet::r8vec_conjugate(int n, double c[])
...
double* wavelet::r8vec_convolution(int m, double x[], int n, double y[])
...
double* wavelet::r8vec_copy_new(int n, double a1[])
...
double* wavelet::r8vec_linspace_new(int n, double a, double b)
...
void wavelet::r8vec_print(int n, double a[], char* title)
...
double* wavelet::r8vec_uniform_01_new(int n, int* seed)
