...
void haar::haar_1d(int n, double x[])
...
void haar::haar_1d_inverse(int n, double x[])
...
void haar::haar_2d(int m, int n, double u[])
...
void haar::haar_2d_inverse(int m, int n, double u[])
...
double* haar::r8mat_copy_new(int m, int n, double a1[])
...
double haar::r8mat_dif_fro(int m, int n, double a[], double b[])
...
void haar::r8mat_print(int m, int n, double a[], string title)
...
void haar::r8mat_print_some(int m, int n, double a[], int ilo, int jlo, int ihi,
...
double* haar::r8mat_uniform_01_new(int m, int n, int* seed)
...
double* haar::r8vec_copy_new(int n, double a1[])
...
double haar::r8vec_diff_norm(int n, double a[], double b[])
...
double* haar::r8vec_linspace_new(int n, double a_first, double a_last)
...
double* haar::r8vec_ones_new(int n)
...
void haar::r8vec_transpose_print(int n, double a[], string title)
...
double* haar::r8vec_uniform_01_new(int n, int* seed)
